/// Located failures while resolving a sample-bank selection pattern.
public enum SampleSelectionPatternError: Error, Equatable, Sendable {
    case emptyInput
    ...
    /// The zero-based UTF-8 source position, or nil for a transform failure.
    public var utf8Offset: Int? {
        switch self {
        case .emptyInput: 0
        case .emptyGroup(let offset): offset
