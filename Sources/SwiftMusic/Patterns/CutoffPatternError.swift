/// Located failures while resolving a low-pass cutoff pattern.
public enum CutoffPatternError: Error, Equatable, Sendable {
    case emptyInput
    ...
    case nonPositiveValue(token: String, index: Int, offset: Int = 0)
    ...
    public var utf8Offset: Int? {
        ...
        case .invalidToken(_, _, let offset),
             ...
             .nonPositiveValue(_, _, let offset),
